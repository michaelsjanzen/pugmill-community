...
| `api:post:response` | Serialised post object returned by `GET /api/posts/[slug]` |
...
| L2 | Post author not displayed in the default theme (`authorId` is stored in the DB but not rendered) | Surface author in default theme in v0.2 |
